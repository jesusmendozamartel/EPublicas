...
<%
	...
	Archivo="Consistencia_er"
	Titulo="CONSISTENCIAS - CUENTAS DEL BALANCE DE COMPROBACIÓN (ESTADO DE RESULTADOS) Y ESTADO FINANCIERO "&annio
	...
	Response.Write("<table ><tr><td colspan='12' align='center'  style=""font-family:Arial, Helvetica, sans-serif; font-size:20px; color:#003300"">"&Titulo&"</td></tr><tr><td>&nbsp;&nbsp;</td></tr><tr>")
	Response.Write("<br>")
