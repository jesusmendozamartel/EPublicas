...
response.write("<table width='50%' border='0' cellspacing='0' cellpadding='0'><tr><td width='24%' valign='top'><table  class='tabla1' width='100%' border='0'>")
	response.write("<tr bgcolor='#FFE2C6'><td colspan='2' rowspan='2' align='center'><strong><font size='2pt'>Información Financiera</font></strong></td><td><strong>Cod_CIIU</strong></td></tr>")
