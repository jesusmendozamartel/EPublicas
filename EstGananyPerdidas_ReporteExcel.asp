...
Response.Charset= "ISO-8859-1" 
	...
	SQL=" exec sp_lista_cuentas_RepAnioGCont '02',"&annio&",'"&gcont&"'"
	...
	Archivo="GananciasPerdidas"
	Titulo="GANANCIAS Y PÉRDIDAS EMPRESAS PÚBLICAS, " &annio&" <br>"&NivText&": "&codText&"<br>"&gcont&" / "&detText&"<br>Soles"
	...
	if detalle =0 then		
		response.write("<tr><td colspan='2' rowspan='6' align='center' style='color:#E3EEF7' bgcolor='#314576'><strong><font size='2pt'>Ganancias y Pérdidas</font></strong></td><td bgcolor='#314576' style='color:#E3EEF7' align='right'>Codigo SICON</td></tr>")
	...
	SQL="EXEC sp_lista_directorio_RepAnioGContNiv '02','"&annio&"','"&nivel&"','"&codigo&"','"&gcont&"','"&detalle&"'"
	SQL2=" exec sp_lista_reporteDatos_RepAnioGContNiv '02','"&annio&"','"&nivel&"','"&codigo&"','"&gcont&"','"&detalle&"'"
