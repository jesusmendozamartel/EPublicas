...
SQL="select Clave_cta,Desc_cta, campo from Sunatma_glosas order by Clave_cta"
	...
	Archivo="InfFinancieraCIIU_"&annio
	Titulo="SUNAT - Información Financiera por CIIU" &annio
	...
	Response.write("<tr bgcolor='#FFE2C6'><td colspan='2' rowspan='2' valign='center' class='act' ><strong><font size='2pt'>Información Financiera</font></strong></td><td align='right' class='act' ><strong>Cod_CIIU</strong></td></tr>")
	...
	SQL="sp_listadatosCIIU '"&annio& "','"&grupo& "','1'" 'cabecera
	SQL2="sp_listadatosCIIU '"&annio& "','"&grupo& "','2'"'cuerpo
