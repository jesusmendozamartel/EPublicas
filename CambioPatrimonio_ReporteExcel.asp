...
Response.Charset= "ISO-8859-1" 
	...
	Titulo="BALANCE GENERAL EMPRESAS PÚBLICAS, " &annio&" <br>"&NivText&": "&codText&"<br>"&gcont&" / "&detText&"<br> Soles"
	...
	elseif detalle =1 then
		response.write("<tr><td colspan='2' align='center' bgcolor='#2e416e'><strong><font size='1pt'>Consolidado EEFF</font></strong></td><td bgcolor='#2e416e' align='right'>"&NivText&"</td></tr>")		
