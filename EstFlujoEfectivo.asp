...
<form action="EstFlujoEfectivo.asp" name="fmrEF" method="post" target=_self>
    ...
    <a class="a2">&nbsp;&nbsp;</a>
	<button onClick="cargaVariableEF('FE'); return false;" style="border:none;height:21px; width:21px;background: url(imagenes/search.png) no-repeat;" alt="Buscar Consulta"></button>
	<button onClick="ExcelEF('FE'); return false;" style="border:none;height:21px; width:21px;background: url(imagenes/excel.png) no-repeat;" alt="Exportar a Excel"></button>
<br>
