...
<strong>
<br>
<font face="Arial" size='3pt' color='#000000'>Estado Flujo Efectivo</font></strong>
<form action="EstFlujoEfectivo.asp" name="fmrEF" method="post" target=_self>
    ...
    <a class="a2">&nbsp;&nbsp;</a>
	<button onClick="cargaVariableEF('EstFlujoEfectivo'); return false;" style="border:none;height:21px; width:21px;background: url(imagenes/search.png) no-repeat;" alt="Buscar Consulta"></button>
	<button onClick="ExcelEF('EstFlujoEfectivo'); return false;" style="border:none;height:21px; width:21px;background: url(imagenes/excel.png) no-repeat;" alt="Exportar a Excel"></button>
<br>
