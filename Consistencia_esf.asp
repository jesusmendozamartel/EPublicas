...
<% Response.Expires= 0 
	...
	End if
	ruta="imagenes"	
	titulo="CUENTAS DEL BALANCE DE COMPROBACIÓN (ESTADO DE SITUACIÓN FINANCIERA) Y ESTADO FINANCIERO"
	pagina="Consistencia_esf"
%>
...
<title>.:INEI-DNCN - Sistema de Empresas Públicas</title>
<style type="text/css">
body {
	margin-left: 0px;
	margin-right: 0px;
