...
Response.Charset= "ISO-8859-1" 
	...
	SQL=" exec [sp_lista_cuentas_fonafe] '22'"
	...
	Archivo="BG_FONAFE"
	Titulo="BALANCE GENERAL - FONAFE "&annio&" <br>"&NivText&": "&codText&"<br> Soles"
	...
	if detalle =0 then		
		response.write("<tr><td colspan='2' rowspan='5' align='center'  style='color:#E3EEF7' bgcolor='#314576'><strong><font size='2pt'>Balance General Fonafe</font></strong></td><td bgcolor='#314576' style='color:#E3EEF7' align='right'>Codigo</td></tr>")
	...
	elseif detalle =1 then
		response.write("<tr><td colspan='2' rowspan='2' align='center' style='color:#E3EEF7' bgcolor='#314576'><strong><font size='1pt'>Balance General Fonafe</font></strong></td><td  style='color:#E3EEF7' bgcolor='#314576' align='right'>&nbsp;</td></tr>")
	...
	SQL="EXEC sp_lista_directorio_fonafe '"&nivel&"','BALANCE_GENERAL_PRO','"&annio&"','"&xtrim&"','"&codigo&"','"&detalle&"'"
	SQL2=" exec sp_lista_reporteDatos_fonafe '65','BALANCE_GENERAL_PRO','"&annio&"','"&xtrim&"','"&nivel&"','"&codigo&"','"&detalle&"'"
