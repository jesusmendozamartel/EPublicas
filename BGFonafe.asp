...
<script type="text/javascript">
	...
	function CargarAnio()
	{
		...
		CargaFiltro("cboAnio",'Filtros.asp?rep=anio_fonafe&tabla=BALANCE_GENERAL_PRO','CargarPeriodo');
	...
	{	
		...
		CargaFiltro("cboTrim",'Filtros.asp?rep=periodo_fonafe&tabla=BALANCE_GENERAL_PRO&anio='+Anio,'cargaCodigos');
	}
 	/*-------------------------------------------------------------------------------------------------------------------*/
	function cargaCodigos(){
		...
		if(nivel==0){
			...
			c.add(option);
				...
				CargaFiltro("cboCodigo",'Filtros.asp?rep=codigo_AnioNiv_fonafe&tabla=BALANCE_GENERAL_PRO&niv='+nivel+'&anio='+anio+'&per='+per,'');
			}
	}
	/*-------------------------------------------------------------------------------------------------------------------*/
...
<strong>
<br>
<div align='center'><font face="Arial" size='3pt' color='#000000'>Balance General Fonafe</font></strong></div>
<form action="BGFonafe.asp" name="fmrEF" method="post" target=_self>

 	<a class="a2">&nbsp;&nbsp;Periodo</a>
 	<select name="cboAnio" id="cboAnio" class="combo2" onChange="CargarPeriodo();"></select>

 	<select name="cboTrim" id="cboTrim" class="combo2" onChange="cargaCodigos();"></select>
    ...
    <a class="a2">&nbsp;&nbsp;</a>
	<button onClick="CargaFonafe('BGFonafe'); return false;" style="border:none;height:21px; width:21px;background: url(imagenes/search.png) no-repeat;" alt="Buscar Consulta"></button>
	<button onClick="CargaFonafeExcel('BGFonafe'); return false;" style="border:none;height:21px; width:21px;background: url(imagenes/excel.png) no-repeat;" alt="Exportar a Excel"></button>
<br>
