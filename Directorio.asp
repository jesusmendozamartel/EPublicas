...
<div align="center">
  <br />
  <strong><font face="Arial" size='3pt' color='#000000'>DIRECTORIO</font></strong></div>
<form action="Directorio.asp" name="fmrEF" method="post" target=_self>
	...
	&nbsp;&nbsp;
	<button onClick="cargaDirectorio(); return false;" style=" border:none; height:21px; width:21Px;font-weight:bold;font-size:8pt;background-color:#ffffff;color:#123456;">
		<img  src="Imagenes/search.png" width="20" height="20" alt="Buscar Consulta" >
	</button>&nbsp;&nbsp;
	<button onClick="cargaDirectorioExcel(); return false;" style=" border:none; height:21px; width:21Px;font-weight:bold;font-size:8pt;background-color:#ffffff;color:#123456;">
