...
SQL="select Clave_cta,Desc_cta, campo from Sunatma_glosas order by Clave_cta"
	...
	Archivo="InfFinancieraSI_"&annio
	Titulo="SUNAT - Información Financiera por Sectores Institucionales" &annio
	...
	Response.write("<tr bgcolor='#FFE2C6'><td colspan='2' rowspan='2' valign='center' class='act' ><strong><font size='2pt'>Información Financiera</font></strong></td><td align='right' class='act' ><strong>Cod_Sector</strong></td></tr>")
