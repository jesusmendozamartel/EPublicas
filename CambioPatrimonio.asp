...
<script type="text/javascript">
	...
	function cargaCodigos(){
		...
		if(nivel==0){
			...
			CargaFiltro("cboCodigo",'Filtros.asp?rep=codigo_AnioeeffGConNiv&anio='+Anio+'&eeff=04&gcon='+GruCont+'&niv='+nivel,'');
		}
	}
...
<strong>
<br>
<font face="Arial" size='3pt' color='#000000'>Cambio de Patrimonio Neto</font></strong>
