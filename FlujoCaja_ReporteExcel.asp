...
Response.Charset= "ISO-8859-1" 
	...
	SQL=" exec [sp_lista_cuentas_fonafe] '21'"
	...
	Archivo="Flujo_Caja"
	Titulo="FLUJO DE CAJA - FONAFE "&annio&" <br>"&NivText&": "&codText&"<br> Soles"
	...
	if detalle =0 then		
		response.write("<tr><td colspan='2' rowspan='5' align='center'  style='color:#E3EEF7' bgcolor='#314576'><strong><font size='2pt'>Flujo de Caja</font></strong></td><td bgcolor='#314576' style='color:#E3EEF7' align='right'>Código</td></tr>")
	...
	elseif detalle =1 then
		response.write("<tr><td colspan='2' rowspan='2' align='center' style='color:#E3EEF7' bgcolor='#314576'><strong><font size='1pt'>Flujo de Caja</font></strong></td><td  style='color:#E3EEF7' bgcolor='#314576' align='right'>&nbsp;</td></tr>")
	...
	SQL="EXEC sp_lista_directorio_fonafe '"&nivel&"','FLUJO_DE_CAJA_PRO','"&annio&"','"&xtrim&"','"&codigo&"','"&detalle&"'"
	SQL2=" exec sp_lista_reporteDatos_fonafe '65','FLUJO_DE_CAJA_PRO','"&annio&"','"&xtrim&"','"&nivel&"','"&codigo&"','"&detalle&"'"
