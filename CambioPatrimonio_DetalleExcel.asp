...
<%
	...
	Archivo="CambioPatrimonioCodiEnt"&CodiEnt
	Titulo="Estados de Cambios en el Patrimonio Neto<br>Empresas Públicas-SICON "&annio
	...
	Response.Write("</tr>")
	Response.Write("<tr bgcolor='#FFFFFF'>")
	Response.Write("<td colspan='4' align='left'>ENTIDAD: "&Rs(2)&"</td>")
	Response.Write("</tr>")
	Response.Write("<tr bgcolor='#FFFFFF'>")
	...
	Response.Write("</tr>")
	Response.Write("<tr bgcolor='#FFFFFF'>")
	Response.Write("<td colspan='4' align='left'>SECTOR: "&Rs(5)&"</td>")
	Response.Write("</tr>")
	Response.Write("</table>")
	Response.Write("<br>")
