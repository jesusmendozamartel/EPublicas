...
Response.Charset= "ISO-8859-1" 
	...
	SQL=" exec sp_lista_ReglasCSI_Anio "&annio
	...
	Archivo="CSI"
	Titulo="CSI, " &annio&" <br>"&NivText&": "&codText&"<br>"&gcont&" / "&detText&"<br> Soles"
	...
	if detalle =0 then	
		response.write("<tr><td colspan='6' rowspan='6' align='center' valign='center' style='color:#E3EEF7' bgcolor='#314576'><strong><font size='2pt'>CSI</font></strong></td><td bgcolor='#314576' style='color:#E3EEF7' align='left'>Codigo SICON</td></tr>")
	...
	while not rs2 is Nothing
		...
		response.write("<tr>")
			for i=0 to Y2
				...
				'else
					if IsNumeric(dato) and z>=44 then
