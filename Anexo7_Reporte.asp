...
'----------------
Titulo1="ANEXO 7 - ACTIVOS INTANGIBLES Y OTROS ACTIVOS"
tablaname="anexo7_res"
campos=136
ntabla=15
'---------------------
...
response.write("<table bgcolor='#FFFFFF' width='100%' border='0' cellspacing='0' cellpadding='0'><tr><td width='50%' valign='top'><table  class='tabla1' width='100%' border='0'>")
	...
	while not rs.eof	' PARA PINTARLO DE NEGRITA Y DE FONDO NARANJA
		if rs(0) ="001" or rs(0) ="014" or rs(0) ="027" or rs(0) ="040" or rs(0) ="053" or rs(0) ="066"  or rs(0) ="079" or rs(0) ="092" or rs(0) ="105" or rs(0) ="118" or rs(0) ="132"  then
				response.write("<tr bgcolor='#FFE296' style=""font-weight:bold"">")
		elseif rs(0) ="133" or rs(0) ="135" then 'PARA PINTARLO DE NEGRITA
...
'-------------------------------------------------------------------------------------------------------------------------------------------------	
	...
	while not rs2 is Nothing
		...
		for j=0 to X2
				...
				if j =0 or j =13 or j =26 or j =39 or j =52 or j =65 or j =78 or j =91 or j =104 or j =117 or j =131 then
					response.write("<tr bgcolor='#FFE296' style=""font-weight:bold"">")
				else
					response.write("<tr>")
				end if
