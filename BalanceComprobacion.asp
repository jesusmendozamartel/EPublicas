...
<script type="text/javascript">
	...
	function CargarAnio()
	{
		CargaFiltro("cboAnio",'Filtros.asp?rep=anioBC','cargaGContable');
	}
	...
	function cargaGContable(){
		var Anio = document.getElementById("cboAnio").value;
		CargaFiltro("cboGruCon",'Filtros.asp?rep=gcontBC_RepAnio&anio='+Anio,'cargaCodigos');
	}
	...
	function cargaCodigos(){
		...
		if(nivel==0){
			...
			CargaFiltro("cboCodigo",'Filtros.asp?rep=codigoBC_AnioGConNiv&anio='+Anio+'&eeff=01&gcon='+GruCont+'&niv='+nivel,'');
		}
	}
...
<strong>
<br>
<font face="Arial" size='3pt' color='#000000'>Balance de Comprobación</font></strong>
<form action="BalanceComprobacion.asp" name="fmrEF" method="post" target=_self>
    ...
    <a class="a2">&nbsp;&nbsp;</a>
	<button onClick="cargaBC(); return false;" style="border:none;height:21px; width:21px;background: url(imagenes/search.png) no-repeat;" alt="Buscar Consulta"></button>
	<button onClick="ExcelBC(); return false;" style="border:none;height:21px; width:21px;background: url(imagenes/excel.png) no-repeat;" alt="Exportar a Excel"></button>
<br>
