...
'-----------------------------	
Titulo1="ANEXO 5 - INMUEBLES, MAQUINARIA Y EQUIPO"
Titulo2=Titulo1&" " &annio&" <br>"&NivText&": "&codText&"<br>"&gcont&" / "&detText&"<br>"&MonedaText&"<br>"
tablaname="anexo5_res"
campos=149
ntabla=13
'------------------------------	
	...
	while not rs.eof	' PARA PINTARLO DE NEGRITA Y DE FONDO NARANJA
		if rs(0) ="001" or rs(0) ="014" or rs(0) ="027" or rs(0) ="040" or rs(0) ="053" or rs(0) ="066"  or rs(0) ="079" or rs(0) ="092" or rs(0) ="105" or rs(0) ="118" or rs(0) ="131" or rs(0) ="145"  then
...
'-------------------------------------------------------------------------------------------------------------------------------------------------	
	...
	while not rs2 is Nothing
		...
		for j=0 to X2
				...
				if j =0 or j =13 or j =26 or j =39 or j =52 or j =65 or j =78 or j =91 or j =104 or j =117 or j =130 or j =144 then
					response.write("<tr bgcolor='#FFE296' style=""font-weight:bold"">")
				else
					response.write("<tr>")
				end if
