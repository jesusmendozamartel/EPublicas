(function() {
  ...
  callWithJQuery(function($, Plotly) {
    ...
    return $.pivotUtilities.plotly_renderers = {
      "Gr\u00E1fico de barras horizontales": makePlotlyChart({
        type: 'bar',
        orientation: 'h'
      }, {
        barmode: 'group'
      }, true),
      "Gr\u00E1fico de barras apiladas H.": makePlotlyChart({
        type: 'bar',
        orientation: 'h'
      }, {
        barmode: 'relative'
      }, true),
      "Gr\u00E1fico de barras": makePlotlyChart({
        type: 'bar'
      }, {
        barmode: 'group'
      }),
      "Gr\u00E1fico de barras apiladas V.": makePlotlyChart({
        type: 'bar'
      }, {
        barmode: 'relative'
      }),
      "Gr\u00E1fico de linea": makePlotlyChart(),
      "Gr\u00E1fico de dispersi\u00F3n": makePlotlyScatterChart()
    };
  });
